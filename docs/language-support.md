...
| --- | --- | --- | --- | --- | --- | --- |
| Python | `python` | `experimental` | Python 扩展和 Pylance | hover、definition hover、function/class docstring | 读取定义附近 `"""..."""`、`'''...'''` docstring；缺少语言服务时安静降级 | Python fixture 覆盖 function/class docstring、变量引用和缺失语言服务降级 |
