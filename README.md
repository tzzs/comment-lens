...
The first version targets Go, TypeScript, JavaScript, TSX, and JSX by reusing the language services already available in VS Code. Python, Java, and Rust support are experimental and should use their recommended language extensions for best hover and definition results. Go projects should install the official Go extension with gopls enabled for best results.
